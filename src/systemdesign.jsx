      ...
      <div style={{ borderBottom: "1px solid #21262d", background: "#0d1117", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 920, margin: "0 auto", padding: "32px 20px 26px", position: "relative" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
            ...
            <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: "#58a6ff", letterSpacing: 3, textTransform: "uppercase", fontWeight: 700, marginLeft: 6 }}>System Design Fundamentals</span>
          </div>

          <h1 style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 30, fontWeight: 800, color: "#f0f6fc", margin: "0 0 6px", letterSpacing: -1 }}>
            System Design <span style={{ color: "#58a6ff" }}>Concepts Reference</span>
          </h1>
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#8b949e", margin: "0 0 18px" }}>
            {SECTIONS.length} concept groups · {totalTopics} topics — definitions, need, breakdowns and code for each principle
          </p>
        </div>
      </div>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 20 }}>
          <input
            ...
            placeholder="Search ACID, SOLID, CAP, caching, sharding, consensus..."
            style={{
              width: "100%",
              padding: "10px 14px",
              background: "#161b22",
        ...
        {filtered.map(section => (
          <div key={section.cat} style={{ marginBottom: 32 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16, paddingBottom: 12, borderBottom: "1px solid #21262d" }}>
              ...
              <span style={{ background: "#161b22", border: `1px solid ${section.color}40`, borderRadius: 12, padding: "2px 10px", fontSize: 11, color: section.color, fontFamily: "'IBM Plex Sans', sans-serif", fontWeight: 600 }}>
                {section.topics.length}
              </span>
            </div>
            <p style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 13, color: "#8b949e", margin: "-8px 0 16px", lineHeight: 1.6 }}>
              {section.desc}
            </p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              {section.topics.map(topic => {
                ...
                const tagC = TAG_META[topic.tag] || TAG_META.SOLID;
                ...
                return (
                  <div key={topic.n}
                    ...
                    <div onClick={() => toggle(section.cat, topic.n)}
                      ...
                      <span style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 10, fontWeight: 700, padding: "3px 8px", borderRadius: 6, background: tagC.bg, color: tagC.text, border: `1px solid ${tagC.border}`, flexShrink: 0, marginTop: 2, letterSpacing: 0.5 }}>
                        {topic.tag}
                      </span>
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {!open && (
                          <div style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 12, color: "#8b949e", marginTop: 3, lineHeight: 1.5, overflow: "hidden", textOverflow: "ellipsis", display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical" }}>
                            {topic.desc.split("\n\n")[0].replace(/[•·]\s[A-Z]+:.*/g, "").trim()}
                          </div>
                        )}
                      </div>

                      <span style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 11, fontWeight: 600, color: open ? section.color : "#8b949e", flexShrink: 0 }}>
                        {open ? "▲" : "▼"}
                      </span>
                    </div>
                    ...
                    {/* Expanded */}
                    {open && (
                      <div style={{ padding: "0 16px 18px 16px", borderTop: "1px solid #21262d" }}>

                        {/* Theory block */}
                        <div style={{ background: "#161b22", border: "1px solid #21262d", borderRadius: 8, padding: "14px 16px", margin: "14px 0 14px" }}>
                          {topic.desc.split("\n\n").map((para, i) => (
                            <p key={i} style={{
                              fontFamily: "'IBM Plex Sans', sans-serif",
                              fontSize: 13,
                              color: para.match(/^[A-Z][A-Z\s\/()0-9]+:/) ? "#c9d1d9" : "#8b949e",
                              lineHeight: 1.8,
                              margin: i === 0 ? "0 0 10px" : "10px 0 0",
                              fontWeight: para.match(/^[A-Z][A-Z\s\/()0-9]+:/) ? 600 : 400
                            }}>
                              {para}
                            </p>
                          ))}
                        ...
                        <div style={{ background: "#0d1117", border: "1px solid #30363d", borderRadius: 6, overflow: "auto" }}>
                          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 14px", borderBottom: "1px solid #21262d", background: "#161b22" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                              ...
                              <span style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 10, color: "#8b949e", textTransform: "uppercase", letterSpacing: 2, fontWeight: 600 }}>{topic.tag}</span>
                            </div>
