...
const COMPLEXITY_PALETTE = {
  bg: "#0E1A2B", border: "#1E3A5F", text: "#93C5FD"
};
  ...
  const filtered = useMemo(() => {
    ...
    return SECTIONS.map(section => {
      ...
      const topics = section.topics.filter(t =>
        ...
        t.complexity.time.toLowerCase().includes(q)
      );
      ...
      <div style={{ borderBottom: "1px solid #21262d", background: "#0d1117", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 920, margin: "0 auto", padding: "32px 20px 26px", position: "relative" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 12 }}>
            ...
            <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: "#58a6ff", letterSpacing: 3, textTransform: "uppercase", fontWeight: 700, marginLeft: 6 }}>Data Structures & Algorithms</span>
          </div>

          <h1 style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 30, fontWeight: 800, color: "#f0f6fc", margin: "0 0 6px", letterSpacing: -1 }}>
            Java <span style={{ color: "#58a6ff" }}>DSA Reference</span>
          </h1>
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: "#8b949e", margin: "0 0 18px" }}>
            {SECTIONS.length} categories · {totalTopics} algorithms — Arrays to DP with complexity analysis
          </p>
        </div>
      </div>
              ...
              {section.topics.map(topic => {
                ...
                return (
                  <div key={topic.n}
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        {!open && (
                          <div style={{ display: "flex", gap: 8, marginTop: 5, flexWrap: "wrap" }}>
                            <span style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 11, color: "#8b949e", background: "#161b22", border: "1px solid #21262d", borderRadius: 6, padding: "2px 8px" }}>
                    ...
                    {/* Expanded */}
                    {open && (
                      <div style={{ padding: "0 16px 16px 35px", borderTop: "1px solid #21262d" }}>

                        {/* Complexity badges */}
                        <div style={{ display: "flex", gap: 8, margin: "14px 0", flexWrap: "wrap" }}>
                          <span style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 12, color: "#8b949e", background: "#161b22", border: "1px solid #21262d", borderRadius: 6, padding: "3px 10px" }}>
                        ...
                        <p style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 13, color: "#8b949e", lineHeight: 1.75, margin: "0 0 14px" }}>
                          {topic.desc}
                        </p>
                        ...
                        <div style={{ background: "#0d1117", border: "1px solid #30363d", borderRadius: 6, overflow: "auto" }}>
                          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "8px 14px", borderBottom: "1px solid #21262d", background: "#161b22" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                              ...
                              <span style={{ fontFamily: "'IBM Plex Sans', sans-serif", fontSize: 10, color: "#8b949e", textTransform: "uppercase", letterSpacing: 2, fontWeight: 600 }}>Java</span>
                            </div>
