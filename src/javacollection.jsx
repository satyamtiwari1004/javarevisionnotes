...
export default function JavaCollections() {
  ...
  const hotCount    = SECTIONS.reduce((s, sec) => s + sec.topics.filter(t => t.star).length, 0);
      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          <p style={{ 
            ...
            {SECTIONS.length} categories · {totalTopics} topics — HashMap internals, ArrayList vs LinkedList, ConcurrentHashMap, and more 
        ...
        <div style={{ marginBottom: 24 }}>
          <input
            ...
            placeholder="Search collections, HashMap, ArrayList, ConcurrentHashMap..."
            style={{
              width: "100%",
              padding: "14px 18px",
            ...
            return (
              <button key={cat} onClick={() => setActiveCat(cat)}
                style={{
                  ...
                  fontWeight: 600,
                  cursor: "pointer",
                  border: active ? `1px solid ${sec?.color || "#06B6D4"}` : "1px solid rgba(48, 54, 61, 0.5)",
                  background: active ? `${sec?.color || "#06B6D4"}20` : "rgba(22, 27, 34, 0.5)",
                  color: active ? (sec?.color || "#06B6D4") : "#8b949e",
                  transition: "all 0.3s ease",
                  backdropFilter: "blur(10px)",
                  WebkitBackdropFilter: "blur(10px)"
                }}
          ...
          <div key={section.cat} style={{ marginBottom: 32 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {section.topics.map(topic => {
                ...
                const tagMeta = TAG_META[topic.tag];

                return (
                  <div key={topic.n} style={{ 
                    background: "linear-gradient(145deg, rgba(22, 27, 34, 0.8) 0%, rgba(13, 17, 23, 0.9) 100%)",
                    backdropFilter: "blur(10px)",
                    WebkitBackdropFilter: "blur(10px)",
                    border: "1px solid rgba(48, 54, 61, 0.5)", 
                    ...
                    >
                      <span style={{ 
                        ...
                        {topic.n}
                        {topic.star && <span title="Most asked in interviews" style={{ color: "#f0c419", marginLeft: 8 }}>★</span>}
                      </span>
                      {!open && (
                        <span style={{ 
                          fontFamily: "'IBM Plex Sans', sans-serif", 
                    ...
                    {/* Expanded */}
                    {open && (
                      <div style={{ padding: "0 20px 24px 20px", borderTop: "1px solid rgba(48, 54, 61, 0.3)" }}>
                        ...
                        <div style={{ 
                          ...
                          <div style={{ 
                            ...
                            <button onClick={() => copy(topic.code, copyKey)}
                              style={{ 
                                background: "none", 
                                border: `1px solid ${copied === copyKey ? section.color : "rgba(48, 54, 61, 0.5)"}`, 
                                borderRadius: 6, 
                                padding: "6px 12px", 
                                color: copied === copyKey ? section.color : "#8b949e", 
                                cursor: "pointer", 
                                fontSize: 12, 
                                fontFamily: "'IBM Plex Sans', sans-serif", 
                                fontWeight: 600, 
